...
def get_map_from_envs(infos, local_map, lmb, origins, num_scenes, global_arch, device):
...
def run_local_planner(num_scenes, 
    ...
    Args:
        num_scenes: 
        global_goals: num_scenes x global waypoints. in pixels, local window origin.
